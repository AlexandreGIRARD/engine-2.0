...
Light::Light(const tinygltf::Light& light)
{
    ...
    if (light.type == "directional")
        m_type = Light_Type::DIRECTIONAL_LIGHT;
    else if (light.type == "point")
        m_type = Light_Type::POINT_LIGHT;
    else
        m_type = Light_Type::SPOT_LIGHT;
    ...
    if (m_type == Light_Type::SPOT_LIGHT) 
    {
